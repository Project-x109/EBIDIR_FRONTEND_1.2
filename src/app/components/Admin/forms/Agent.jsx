...
import {clearErrors, registerAgent } from "../../../../Actions/UserAction";
...
const Agent = () => {
  ...
  const { loading, success, error } = useSelector((state) => state.newagent);
  ...
  const handleRegister = (e) => {
    ...
    dispatch(registerAgent(dataCollected));
  ...
  return (
    <div style={{ textTransform: "capitalize" }}>
      ...
      <div className="page-header">
        <h3 className="page-title">Registration Form for Agents</h3>
          ...
          <span className="reloder"> {loading && <BackdropLoader />}</span>
            <div className="card-body">
              ...
              <form className="form-sample">
                ...
                <div disabled={formSubmitted && loading} className="row">
                  <Tooltip  arrow title="Upload Your Image in jpg format">
                    <HandleLogoChange disabled={formSubmitted && loading} handleLogoChange={handleLogoChange} />
                  </Tooltip>
                </div>
                <div className="row">
                  {profile ? (
